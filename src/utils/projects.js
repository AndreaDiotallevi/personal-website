const projects = [
  ...
  },
  {
    name: "Albums Manager",
    overview:
      "A full-stack web application built with the MERN stack and the LastFM API that lets a user manage his personal albums collection. The user can add new albums, view albums information, loan and return them.",
